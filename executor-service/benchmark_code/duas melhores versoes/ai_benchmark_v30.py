    ...
    def _plot_bar_charts(self, df_plot, ai_list, cmap, challenge_order, ts, out_dir):
        ...
        for key, (title, ylabel, col_name) in metrics_to_plot.items():
            ...
            try:
                ...
                # --- CORREÇÃO APLICADA ---
                ax.tick_params(axis='x', rotation=45, labelsize=9) # Remove ha e rotation_mode
                plt.setp(ax.get_xticklabels(), ha="right", rotation_mode="anchor") # Define para as etiquetas
                # --- FIM DA CORREÇÃO ---
    ...
    def _plot_box_plots(self, df_agg, ai_list, cmap, ts, out_dir):
        ...
        for col_name, config in metrics_to_plot.items():
            ...
            try:
                ...
                # --- CORREÇÃO APLICADA ---
                ax.tick_params(axis='x', rotation=30, labelsize=9) # Remove ha e rotation_mode
                plt.setp(ax.get_xticklabels(), ha="right", rotation_mode="anchor") # Define para as etiquetas
                # --- FIM DA CORREÇÃO ---
