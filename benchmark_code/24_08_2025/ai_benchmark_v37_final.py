...
class AIBenchmark:
    ...
    def __init__(
        ...
        # --- Definição Completa dos Desafios ---
        self.code_challenges = [
            ...
            {
                "name": self.CHALLENGE_LRU_CACHE,
                "description": "Implement a Least Recently Used (LRU) cache with a given capacity.",
                "difficulty": "Hard",
                ...
                "test_cases": [
                    {
                        ...
                        "sequence": [
                            {"op": "__init__", "args": [2]}, {"op": "put", "args": [1, 1]},
                            {"op": "put", "args": [2, 2]}, {"op": "get", "args": [1], "expected": 1},
                            {"op": "put", "args": [3, 3]}, {"op": "get", "args": [2], "expected": -1},
                            {"op": "put", "args": [4, 4]}, {"op": "get", "args": [1], "expected": -1},
                            {"op": "get", "args": [3], "expected": 3}, {"op": "get", "args": [4], "expected": 4},
                        ],
                    },
                ],
            },
            {
                "name": self.CHALLENGE_TWO_SUM,
                "description": "Given a list of integers `nums` and a target, return indices of two numbers that add up to target.",
                "difficulty": "Easy",
    ...
    def generate_report(self):
        ...
        # Esta é uma versão simplificada da sua lógica original de relatórios.
        # Você pode colar aqui toda a sua lógica de `generate_report` da versão v32.
